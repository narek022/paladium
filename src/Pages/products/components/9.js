        ...
        <Col className="slide">
          <Card>
            <button className="btn" onClick={handleShow}>
              <Card.Img className="pic" variant="top" src={img1} />
            </button>
        ...
        <Col className="slide">
          <Card>
            <button className="btn" onClick={handleShow4}>
              <Card.Img className="pic" variant="top" src={img4} />
            </button>
        ...
        <Col className="slide">
          <Card>
            <button className="btn" onClick={handleShow5}>
              <Card.Img className="pic" variant="top" src={img5} />
            </button>
        ...
        <Col className="slide">
          <Card>
            <button className="btn" onClick={handleShow6}>
              <Card.Img className="pic" variant="top" src={img6} />
            </button>
        ...
        <Col className="slide">
          <Card>
            <button className="btn" onClick={handleShow7}>
              <Card.Img className="pic" variant="top" src={img7} />
            </button>
        ...
        <Col className="slide">
          <Card>
            <button className="btn" onClick={handleShow8}>
              <Card.Img className="pic" variant="top" src={img8} />
            </button>
        ...
        <Col className="slide">
          <Card>
            <button className="btn" onClick={handleShow9}>
              <Card.Img className="pic" variant="top" src={img9} />
            </button>
